...
from app import FunnelVisualizer, ColorPalette, LayoutConfig
...
class TestTimeSeriesChartLayout:
    ...
    @pytest.mark.parametrize("dataset_size,expected_height_range", [
...
class TestChartStretchingFix:
    ...
    def test_fix_height_calculation(self):
        ...
        def get_improved_responsive_height(base_height: int, content_count: int = 1) -> int:
            ...
            scaling_factor = min(content_count - 1, 20) * 20  # Max 20 items of scaling, 20px per item
