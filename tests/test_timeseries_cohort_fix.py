...
class TestTrueTimeCohortAnalysis:
    ...
    def test_current_implementation_breaks_cohort_logic(self, cross_period_conversion_data, cohort_calculator):
        """
        ...
        print(f"  Период 1 (2024-01-01): ожидаем 1 started, 1 completed, 100%")
        print(f"  Период 2 (2024-01-02): ожидаем 1 started, 1 completed, 100%")
    ...
    def test_multi_day_conversion_window_cohort(self, cohort_calculator):
        ...
        print(f"\nАнализ результатов:")
        print(f"День 1: {day1['started_funnel_users']} started, {day1['completed_funnel_users']} completed")
        print(f"День 2: {day2['started_funnel_users']} started, {day2['completed_funnel_users']} completed")
    ...
    def test_pandas_fallback_cohort_logic(self, cohort_calculator):
        ...
        data = [
            {'user_id': 'A', 'event_name': 'signup', 
             'timestamp': datetime(2024, 1, 1, 23, 30), 'event_properties': '{}'},
            {'user_id': 'A', 'event_name': 'purchase', 
             'timestamp': datetime(2024, 1, 2, 1, 30), 'event_properties': '{}'},
            {'user_id': 'B', 'event_name': 'signup', 
             'timestamp': datetime(2024, 1, 2, 10, 0), 'event_properties': '{}'},
            {'user_id': 'B', 'event_name': 'purchase', 
             'timestamp': datetime(2024, 1, 2, 11, 0), 'event_properties': '{}'},
        ]
