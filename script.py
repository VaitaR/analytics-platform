...
demo_events = [
    {"name": "User Sign-Up", "category": "Authentication", "description": "User creates new account", "frequency": "high"},
    {"name": "Verify Email", "category": "Authentication", "description": "Email verification completed", "frequency": "high"},
    {"name": "First Login", "category": "Authentication", "description": "User logs in for first time", "frequency": "high"},
    {"name": "Profile Setup", "category": "Onboarding", "description": "User completes profile information", "frequency": "medium"},
    {"name": "Tutorial Completed", "category": "Onboarding", "description": "User finishes onboarding tutorial", "frequency": "medium"},
    {"name": "Add to Cart", "category": "E-commerce", "description": "Item added to shopping cart", "frequency": "high"},
    {"name": "Checkout Started", "category": "E-commerce", "description": "User begins checkout process", "frequency": "high"},
    {"name": "Payment Info Entered", "category": "E-commerce", "description": "Payment information provided", "frequency": "medium"},
    {"name": "Payment Completed", "category": "E-commerce", "description": "Transaction successfully processed", "frequency": "high"},
    {"name": "First Purchase", "category": "E-commerce", "description": "User makes first purchase", "frequency": "medium"},
    {"name": "Product View", "category": "Engagement", "description": "User views product details", "frequency": "high"},
    {"name": "Search Performed", "category": "Engagement", "description": "User searches for products", "frequency": "high"},
    {"name": "Wishlist Added", "category": "Engagement", "description": "Item added to wishlist", "frequency": "low"},
    {"name": "Review Submitted", "category": "Engagement", "description": "User submits product review", "frequency": "low"},
    {"name": "Share Product", "category": "Social", "description": "User shares product on social media", "frequency": "low"},
    {"name": "Invite Friend", "category": "Social", "description": "User invites friend to platform", "frequency": "low"},
    {"name": "App Downloaded", "category": "Mobile", "description": "Mobile app downloaded", "frequency": "medium"},
    {"name": "Push Notification Enabled", "category": "Mobile", "description": "User enables push notifications", "frequency": "medium"}
]
...
properties = [
    ...
    {"name": "campaign", "type": "string", "values": ["organic", "paid_search", "social", "email"]},
